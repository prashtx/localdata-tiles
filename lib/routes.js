...
var arcgis = require('./controllers/arcgis');
...
var useEtagCache = require('./cache/etag-cache')();
var util = require('./controllers/util');

var useCache, useCacheFeatures, useCacheArcGIS;
...
exports.setup = function setup(app) {
  ...
  app.get('/arcgis/layers/:layerId', tileJson.getLayerDef);

  app.get(
    '/arcgis/layers/:layerId/tiles/:zoom/:x/:y.png',
    parseTileName,
    respondWithBlankTile,
    useCacheArcGIS,
    arcgis.render
  ...
  app.get(
    '/arcgis/layers/:layerId/utfgrids/:zoom/:x/:y.:format',
    parseTileName,
    respondWithBlankTile,
    useCacheArcGIS,
    arcgis.renderGrids
